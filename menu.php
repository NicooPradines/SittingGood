...
<body>
        ...
        <div class="container form-container">
            <form>
                <div class="mb-3">
                    ...
                    <select id="sillaTipo" class="form-select">
                ...
                <div class="mb-3">
                    ...
                    <input type="range" id="altura" class="form-range" min="100" max="220" step="1">
                </div>
                <div class="mb-3">
                    <label for="peso" class="form-label">Ingrese su peso (kg)</label>
                    <input type="range" id="peso" class="form-range" min="30" max="150" step="1">
                </div>
                <div class="mb-3">
                    <label for="colorSilla" class="form-label">¿Qué color de silla desea?</label>
                    <select id="colorSilla" class="form-select">
                ...
                <div class="mb-3">
                    ...
                    <select id="modeloSilla" class="form-select">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Aquí puedes mostrar imágenes de los modelos.
                            </div>
                ...
                <div class="mb-3">
                    ...
                    <select id="tipoRespaldo" class="form-select">
                        <option selected>Seleccione una opción</option>
                ...
                <div class="mb-3">
                    ...
                    <select id="apoyacabezas" class="form-select">
                        <option selected>Seleccione una opción</option>
                ...
                <div class="mb-3">
                    ...
                    <select id="reclinable" class="form-select">
                        <option selected>Seleccione una opción</option>
                        <option value="1">Sí</option>
                        <option value="2">No</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select id="giratoria" class="form-select">
                        <option selected>Seleccione una opción</option>
                        <option value="1">Sí</option>
                        <option value="2">No</option>
                    </select>
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-success btn-custom">Enviar información</button>
                </div>
            </form>
        </div>
    </center>
    ...
    <footer class="text-body-secondary py-5">
        ...
        <div class="container">
            ...
            <p>Av. Lisandro de la Torre 2135 (CABA)</p>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp"
                viewBox="0 0 16 16">
                <path
                    d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232" />
            </svg>
            <p>+54 9 (11) 2455 6036</p>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-envelope-fill" viewBox="0 0 16 16">
                <path
                    d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414zM0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zm3.436-.586L16 11.801V4.697z" />
            </svg>
            <p>ventas@sitting-good.com.ar</p>
